...
module.exports = {
  ...
  keycloak: {
    ...
    redirectUrl: 'http://192.168.30.56:8010/keycloak/callback',
    idp: 'osspid'
  },
  ...
  osspid: {
    ...
    redirectUrl: 'http://192.168.30.56:8010/osspid-direct/callback'
  },

  // UATID Configuration (via Keycloak - separate realm and client)
  uatid: {
    realm: 'uat-id-realm',
    clientId: 'uat-id-client',
    clientSecret: 'RLSJW5eSqDokzmtObt4bHDiSH0YBpV9e',
    redirectUrl: 'http://192.168.30.56:8010/uatid/callback',
    idpHint: 'uatid'
  },
